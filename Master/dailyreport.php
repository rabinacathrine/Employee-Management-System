<?php
$link = mysqli_connect("localhost", "root", "", "fenix");
...
<center><h3>Daily Report</h3>
<center><input type="text" name="From" id="From" class="form-control-sm" placeholder="From Date"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="to" id="to" class="form-control-sm" placeholder="To Date"/>
</br>
</br>
<input type="button" name="range" id="range" value="Range" class="btn btn-info"/></center>
